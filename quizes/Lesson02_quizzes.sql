/***********************************************
   Lesson 2.4 | Quiz: Your first JOIN
 ***********************************************/
 ...
 */
SELECT orders.standard_qty, orders.gloss_qty, poster_qty, accounts.website, accounts.primary_poc
FROM orders
JOIN accounts
ON orders.account_id = accounts.id;
...
/***********************************************
   Lesson 2.11 | Quiz: Quiz: JOIN Questions Part 1
 ***********************************************/
 ...
 */
SELECT s.name sales_rep, a.name acount_name, r.name region_name
FROM sales_reps s
JOIN accounts a
...
/* Question 3:
   ...
   dividing by zero.
 */
SELECT r.name reg_name, a.name account_name, o.total_amt_usd/(o.total+0.01) unit_price
FROM orders o
JOIN accounts a
...
/* Question 1:
   ...
   name.
 */
SELECT r.name reg_name, s.name sales_rep, a.name account_name
FROM sales_reps s
JOIN region r
ON r.id = s.region_id
AND r.name = 'Midwest'
